...
#+begin_src conf :tangle .github/workflows/deploy.yaml
...
jobs:
  tangle-and-push:
    ...
    - name: Checkout tangled branch
      run: |
        git config --global user.email "1713464+zeeros@users.noreply.github.com"
        git config --global user.name "zeeros"
        git add -f *
